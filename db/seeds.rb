...
apple = Product.create(name: 'apple', image: 'https://ua.all.biz/img/ua/catalog/3009418.jpeg', quantity: "10", category_id: fruite.id, stack: 10, price: 20.9 , farm: "مزرعه الحمد", description: "مرره لذيذ")
...
blueberry = Product.create(name: 'bluberry', image: 'https://cdn.pixabay.com/photo/2018/06/07/16/38/blueberry-3460423_1280.jpg', quantity: 7, category_id: fruite.id, stack: 3, price: 20 , farm: "مزرعه الحمد", description: "مرره لذيذ")
...
Oats = Product.create(name: 'Oats', image: 'https://cdn.firstcrycdn.com/2018/04/641287948-H.jpg', quantity: 4, category_id: seed.id,stack: 10, price: 20 , farm: "مزرعه الحمد", description: "مرره لذيذ")
